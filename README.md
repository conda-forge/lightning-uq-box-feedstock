...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/lightning-uq-box-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lightning-uq-box-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add lightning-uq-box
# for installing globally
pixi global install lightning-uq-box
```
...
It is possible to list all of the versions of `lightning-uq-box` available on your platform:
...
```
pixi search lightning-uq-box --channel conda-forge
```
